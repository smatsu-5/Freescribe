...
export default function FileDisplay(props) {
    ...
    return (
        <main className='flex-1 p-4 flex flex-col gap-3 sm:gap-4  
            text-center justify-center pb-20 w-72 sm:w-96 max-w-full mx-auto'>
            <h1 className='font-semibold text-4xl sm:text-5xl 
                md:txt-6xl'>Your <span className='text-blue-400 bold'>File</span>
            </h1>
            ...
            <div className='flex items-center justify-between gap-4'>
                <button onClick={handleAudioReset} className='text-slate-400 hover:text-blue-600 duraton-200'> 
                    Reset
                </button>
