  ...
  return (
    <main className='flex-1 p-4 flex flex-col gap-3 sm:gap-4 text-center justify-center pb-20'>
        <h1 className='font-semibold text-5xl sm:text-6xl 
            md:txt-7xl'>Free<span className='text-blue-400 bold'>Scribe</span>
        </h1>
        ...
        <button onClick={recordingStatus === 'recording' ? stopRecording : startRecording} className='specialBtn px-2 py-4 rounded-xl flex items-center text-base justify-between gap-4 mx-auto w-72 max-w-full my-4'>
